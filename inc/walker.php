...
if (! class_exists ( 'WP_Smart_Light_Navwalker' )) :
 ...
 */
class WP_Smart_Light_Navwalker extends Walker_Nav_Menu {
  /**
  ...
  public function start_lvl( &$output, $depth = 0, $args = array() ) {
    ...
    $output .= "\n$indent<ul class=\" dropdown-menu dropdown-content\" role=\"menu\">\n";
  }
